  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-4 py-4 sm:px-6 lg:px-8 lg:py-6">
      ...
      <div className="mx-auto flex min-h-screen max-w-4xl items-center">
        <Card className="w-full rounded-[30px] border-white/70 bg-[linear-gradient(135deg,rgba(255,255,255,0.97),rgba(247,250,252,0.92))] shadow-soft">
          <CardHeader className="space-y-4 border-b border-slate-200/80 pb-5">
            ...
            <CardTitle className="text-2xl text-slate-950">
              Le calendrier RH n&apos;a pas pu s&apos;afficher correctement
            </CardTitle>
            <p className="max-w-2xl text-sm leading-6 text-slate-600">
              Une erreur inattendue a interrompu le chargement du calendrier.
              Aucune action n&apos;a été appliquée.
            </p>
          </CardHeader>
